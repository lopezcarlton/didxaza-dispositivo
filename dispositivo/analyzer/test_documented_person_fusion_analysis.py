...
class OrthographicProsodyLicenseTests(unittest.TestCase):
    def test_riniti_is_licensed_as_grave_final_i(self):
        ...
        self.assertEqual(detail["prosodic_license_status"], "GRAVE_LICENSED_BY_GP_SPANISH_STRESS_ORTHOGRAPHY")
    ...
    def test_monosyllable_is_blocked(self):
        ...
        self.assertIn("MONOSYLLABLE_OR_UNDERDETERMINED_SYLLABLE_COUNT", detail["blockers"])
    ...
    def test_glottal_headword_blocks_this_rule(self):
        ...
        self.assertFalse(licensed)
        self.assertIn("GLOTTAL_MARK_PRESENT_PROSODIC_PATH_NOT_THIS_RULE", detail["blockers"])
...
class CurrentAnalyzerDocumentedFusionTests(unittest.TestCase):
    ...
    def test_rinite_is_documented_1sg_analysis_not_exact_attestation(self):
        ...
        self.assertEqual(result["analysis_status_promotion_basis"], "DOCUMENTED_MORPHOLOGICAL_RULE_APPLICATION_TO_OBSERVED_SURFACE")
        ...
        self.assertEqual(analysis["epistemic_status"], "SOURCE_DOCUMENTED_RULE_APPLICATION_TO_OBSERVED_SURFACE")
